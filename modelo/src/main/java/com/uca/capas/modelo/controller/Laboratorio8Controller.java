...
public class Laboratorio8Controller {
	...
	public ModelAndView	procAlmacenado(){
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView ejercutarProcedimiento(@RequestParam Integer cliente, @RequestParam Boolean estado){
		ModelAndView mav = new ModelAndView();
		Integer resultado;
